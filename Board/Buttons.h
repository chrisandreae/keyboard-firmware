...
#define __BUTTONS_MINIMUS_H__
	...
	/* Public Interface - May be used in end-application: */
		/* Macros: */
			...
			#define BUTTONS_BUTTON2      (1 << 4) // 5 and 6 are LEDs
			#define BUTTONS_BUTTON3      (1 << 3)
			#define BUTTONS_BUTTON4      (1 << 2)
			#define BUTTONS_ALL          (BUTTONS_BUTTON1 | BUTTONS_BUTTON2 | BUTTONS_BUTTON3 | BUTTONS_BUTTON4)
	
		/* Inline Functions: */
		#if !defined(__DOXYGEN__)
			static inline void Buttons_Init(void)
			{
				DDRD  &= ~BUTTONS_ALL;  // 0 = input pin
				PORTD |=  BUTTONS_ALL;  // 1 = pull-up enabled
			}
