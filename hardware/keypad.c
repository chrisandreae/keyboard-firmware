...
const logical_keycode matrix_to_logical_map[MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    {NO_LHS_KEY, NO_RHS_KEY, NO_LHS_KEY, NO_RHS_KEY, LOGICAL_KEY_LHS_TP6 , LOGICAL_KEY_RHS_TP6 , LOGICAL_KEY_LHS_TP5 , LOGICAL_KEY_RHS_TP5 , LOGICAL_KEY_LHS_TP4 , LOGICAL_KEY_RHS_TP4 , LOGICAL_KEY_LHS_TP3 , LOGICAL_KEY_RHS_TP3 , LOGICAL_KEY_LHS_TP2 , LOGICAL_KEY_RHS_TP2 , LOGICAL_KEY_LHS_TP1 , LOGICAL_KEY_RHS_TP1 },
};
