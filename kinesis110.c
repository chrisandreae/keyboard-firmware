...
const logical_keycode matrix_to_logical_map[MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
	...
	/*J7-4 */   { LOGICAL_KEY_5,   LOGICAL_KEY_B,      LOGICAL_KEY_R,           LOGICAL_KEY_4,      LOGICAL_KEY_RIGHT,         LOGICAL_KEY_C,         LOGICAL_KEY_D,         NO_KEY               },
	/*J7-5 */   { LOGICAL_KEY_T,   LOGICAL_KEY_G,      LOGICAL_KEY_F,           LOGICAL_KEY_V,      LOGICAL_KEY_LEFT,          LOGICAL_KEY_3,         LOGICAL_KEY_E,         NO_KEY               },
